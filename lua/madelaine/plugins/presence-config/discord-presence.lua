...
require("presence").setup({
	...
	neovim_image_text = "✨ Struggling here ~ 🌙", -- Text displayed when hovered over the Neovim image
	...
	editing_text = "ʕノ•ᴥ•ʔノ ︵ ┻━┻ 🙃 🕳️", -- Format string rendered when an editable file is loaded in the buffer (either string or function(filename: string): string)
