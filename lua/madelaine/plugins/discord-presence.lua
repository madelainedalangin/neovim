-- import gitsigns plugin safely local presence, gitsigns = pcall(require, "presence")
if not setup then
	return
end
...
require("presence").setup({
	...
	editing_text = "ʕノ•ᴥ•ʔノ ︵ ┻━┻", -- Format string rendered when an editable file is loaded in the buffer (either string or function(filename: string): string)
	...
	git_commit_text = "¯_(ツ)_/¯", -- Format string rendered when committing changes in git (either string or function(filename: string): string)
